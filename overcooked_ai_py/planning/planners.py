...
class MotionPlanner(object):
    ...
    def _get_valid_successor_motion_states(self, start_motion_state):
        ...
        return [
            (action, self.mdp._move_if_direction(start_position, start_orientation, action))
    ...
    def _calculate_heuristic_costs(self):
        ...
        onion_delivery_cost = self.min_cost_between_features(
            onion_locations, delivery_locations, manhattan_if_fail=False
        )
        tomato_delivery_cost = self.min_cost_between_features(
...
class JointMotionPlanner(object):
    ...
    def _handle_conflict_with_same_goal_idx(
        self, joint_start_state, joint_goal_state, action_plans, pos_and_or_paths, wait_agent_idx
    ):
        """
